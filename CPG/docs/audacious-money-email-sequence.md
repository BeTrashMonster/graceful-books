# Understanding Your True Costs — Email Sequence
*Audacious Money · Workshop July 8th, 10am–12pm*

> **Placeholders to fill in:** `[First Name]`, `[Your name]`, `[address]`, `[worksheet link]`, `[countdown page link]`, `[X hours]`. Each email has a **Subject** and a **Preheader** (the gray preview text after the subject line) so they're ready to drop into your email platform.

---

## EMAIL 1 — Welcome (sent on sign-up, ~1 week before class)
...
Once your worksheet is done, you'll land on the **countdown page** — it'll tick down to July 8th for our workshop and when the full app opens up for you.
...
## EMAIL 2 — Reminder (configurable hours before the workshop - set by admin)
...
- ✅ **Your worksheet is complete** — one product, invoices added. If it's not quite finished, that's okay. Do what you can. → **[Finish your worksheet] https://app.audacious.money/login**
