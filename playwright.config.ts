...
/**
 * Playwright Configuration for Graceful Books E2E Tests
 *
 * Tests Group D guided setup workflows:
 * - D1: Chart of Accounts setup
 * - D2: First reconciliation experience
 * - D3: Email summary configuration
 * - D4: Tutorial completion
...
export default defineConfig({
  ...
  use: {
    ...
    // Must match port in vite.config.ts (server.port: 3006)
