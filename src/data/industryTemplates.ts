...
const FREELANCER_TEMPLATE: IndustryTemplate = {
  ...
  accounts: [
    ...
    },
    {
      ...
      explanation: 'Big purchases that last multiple years (typically $2,500+). Check current IRS capitalization thresholds - items below the threshold should be expensed, not capitalized as assets.',
      isRequired: false,
      isDefault: true,
    },
    ...
    },
    {
      ...
      explanation: 'This tracks what you owe in taxes. Ensure you\'re aware of estimated tax payment deadlines (typically quarterly: April 15, June 15, Sept 15, Jan 15). Consider setting aside 25-30% of income in a separate savings account.',
      isRequired: true,
      isDefault: true,
    },
    ...
    },
    {
      ...
      explanation: 'Fees from Stripe, Square, PayPal, and other payment processors. Track these separately from bank fees!',
      isRequired: false,
      isDefault: true,
    },
    {
...
const CREATIVE_TEMPLATE: IndustryTemplate = {
  ...
  accounts: [
    ...
    },
    {
      ...
      explanation: 'Valuable creative tools that last multiple years (typically $2,500+). Check current IRS capitalization thresholds - smaller purchases should be expensed, not capitalized.',
      isRequired: true,
      isDefault: true,
    },
    {
    ...
    },
    {
      ...
      type: 'liability',
      description: 'Tax obligations',
      explanation: 'Tracks what you owe in taxes. Stay aware of estimated tax payment deadlines (typically quarterly: April 15, June 15, Sept 15, Jan 15). Set aside 25-30% of income conservatively.',
      isRequired: true,
      isDefault: true,
    },
    ...
    },
    {
      ...
      explanation: 'Fees from Stripe, Square, PayPal, and other payment processors when clients pay you online.',
      isRequired: false,
      isDefault: true,
    },
    {
...
const RETAIL_TEMPLATE: IndustryTemplate = {
  ...
  accounts: [
    ...
    },
    {
      ...
      explanation: 'Major equipment like shelving, POS systems, computers (typically $2,500+). Check current IRS capitalization thresholds - smaller items should be expensed.',
      isRequired: false,
      isDefault: true,
    },
...
const SERVICE_TEMPLATE: IndustryTemplate = {
  ...
  accounts: [
    ...
    },
    {
      ...
      explanation: 'Major equipment like trucks, mowers, and heavy tools (typically $2,500+). Check current IRS capitalization thresholds - smaller items should be expensed, not capitalized.',
      isRequired: true,
      isDefault: true,
    },
    {
    ...
    },
    {
      ...
      type: 'liability',
      description: 'Tax obligations',
      explanation: 'Tracks taxes owed (quarterly estimated, payroll, sales tax). Be aware of payment deadlines - estimated taxes typically due quarterly: April 15, June 15, Sept 15, Jan 15.',
      isRequired: true,
      isDefault: true,
    },
    ...
    },
    {
      ...
      type: 'expense',
      description: 'Payment processing fees',
      explanation: 'Stripe, Square, PayPal fees when customers pay by card. Track these separately!',
      isRequired: false,
      isDefault: true,
    },
    {
...
const GENERAL_TEMPLATE: IndustryTemplate = {
  ...
  accounts: [
    ...
    },
    {
      ...
      type: 'expense',
      description: 'Payment processing fees',
      explanation: 'Stripe, Square, PayPal fees and other payment processor charges.',
      isRequired: false,
      isDefault: true,
    },
  ],
