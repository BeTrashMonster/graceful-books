...
const FREELANCER_TEMPLATE: IndustryTemplate = {
  ...
  accounts: [
    ...
    },
    {
      ...
      accountNumber: '2100',
      type: 'liability',
      description: 'Estimated taxes set aside',
      explanation: 'Money you owe in taxes. Set aside 25-30% of income here so tax time isn\'t scary.',
      isRequired: true,
      isDefault: true,
    },
    ...
    // Equity
    {
      ...
      explanation: 'This tracks what you\'ve invested. Starting with $0? That\'s okay - it\'ll grow!',
      isRequired: true,
      isDefault: true,
    },
    {
    ...
    },
    {
      ...
      explanation: 'Automatically calculated. This shows profit you\'ve made but left in the business to grow.',
      isRequired: true,
      isDefault: true,
    },
    ...
    },
    {
      ...
      explanation: 'Adobe, Microsoft 365, project management tools - the software that keeps you productive.',
      isRequired: true,
      isDefault: true,
    },
    {
