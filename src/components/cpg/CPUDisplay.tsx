...
export function CPUDisplay({
  ...
  const handleDrop = (e: React.DragEvent, targetIndex: number) => {
    ...
    const draggedPosition = productPositions[draggedProductKey];

    // Check if target position is occupied by another product
    const targetProductKey = Object.entries(productPositions).find(
    ...
    setProductPositions(prev => {
      ...
      if (targetProductKey) {
        ...
        updated[targetProductKey] = draggedPosition;
        updated[draggedProductKey] = targetIndex;
      } else {
  ...
  const exportCSVSummary = () => {
    const headers = ['Product', 'SKU', 'Cost', 'Selling Price', 'Profit', 'Margin %', 'Status'];
                  ...
                  >
                    ...
                    {!hasRecipe ? (
                      ...
                      <>
                        ...
                        {/* Profit, Margin & Selling Price - Context Below */}
                        <div style={{
                          display: 'grid',
                ...
                <table style={{
                  ...
                  <thead>
                    <tr style={{
                      ...
                      <SortableHeader column="msrp" label="Selling Price" align="right" />
