/**
 * Frozen State Components
 *
 * Components for managing the frozen account state UX.
 * When a user's trial expires or subscription is cancelled,
 * these components provide guidance and reactivation flows.
 *
