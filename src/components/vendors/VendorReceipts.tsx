/**
 * VendorReceipts Component
 *
 * Displays receipts interface within the Vendors page.
 * Mirrors the functionality of the Receipts page.
 *
 * Features:
...
import { ReceiptLinkModal, type Transaction } from '../receipts/ReceiptLinkModal'
...
import styles from './VendorReceipts.module.css'

export interface VendorReceiptsProps {
  /**
   * Current company ID
   */
  companyId: string
 ...
 * VendorReceipts Component
 */
export const VendorReceipts: FC<VendorReceiptsProps> = ({ companyId }) => {
