...
type ViewMode = 'seasonal' | 'distributor' | 'promo-tracker';
...
interface HistoricalAnalyticsProps {
  initialTab?: 'seasonal' | 'distributor-cost' | 'promo-tracker';
...
export default function HistoricalAnalytics({ initialTab: propInitialTab, hideNavigation = false }: HistoricalAnalyticsProps = {}) {
  ...
  const initialTab = tabParam && ['seasonal', 'distributor', 'promo-tracker'].includes(tabParam)
    ? tabParam
    : (mappedPropTab || 'seasonal');
