...
export const emailVerificationTemplate: EmailTemplate = {
  subject: 'Welcome to Audacious Money! Let\'s verify your email',
  html: `
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <p>Hi {{firstName}},</p>
          <p>We're so excited to have you here! You're just one click away from taking control of your financial journey.</p>
          ...
          <p>Can't wait to see what you'll accomplish! 💪</p>
...
We're so excited to have you here! You're just one click away from taking control of your financial journey.

Click this link to verify your email address and get started:
{{verificationLink}}
  ...
  html: `
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <p>Hi {{firstName}},</p>
          <p>Exciting news! Your 30-day trial of <strong>{{productName}}</strong> is now active.</p>
          <div class="highlight">
          ...
          <p>Your trial will end on <strong>{{trialEndDate}}</strong>. We'll send you a reminder before it expires.</p>
          <p>Ready to dive in? Start exploring and see how {{productName}} can transform your financial journey!</p>
          <p>Cheering you on,<br>The Audacious Money Team</p>
        </div>
        <div class="footer">
...
Exciting news! Your 30-day trial of {{productName}} is now active.
...
Your trial will end on {{trialEndDate}}. We'll send you a reminder before it expires.

Ready to dive in? Start exploring and see how {{productName}} can transform your financial journey!
