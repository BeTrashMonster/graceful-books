...
export async function sendWorkshopWelcomeEmail(
  ...
  const defaultHtmlBody = `
      <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>I know your formulations are sacred — they are the heart of everything you have built. So let me be completely clear: your data stays on your device. Your recipes, your invoices, your numbers are stored locally and never sent to our servers.</p>
...
Now, about your recipes: Your data stays on your device. Your recipes, your invoices, your numbers are stored locally and never sent to our servers.
